...
class GustavoPage extends StatelessWidget {
  final String githubUrl = "https://github.com/GustavoSilverio";
  final String linkedinUrl = "https://www.linkedin.com/in/gustavosilverioo/";
  final String email = "gustavosk290905@gmail.com";

  const GustavoPage({super.key});
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsets.symmetric(vertical: screenHeight * 0.02),
                      child: Text(
                        'Planejamento e desenvolvimento do Front-web',
